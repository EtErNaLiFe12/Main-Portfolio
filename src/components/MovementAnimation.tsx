...
export default function MovementAnimation() {
  return (
    <>
      ...
      {/* <Box sx={{ position: 'absolute', right: 20, mt: -20 }}>
        <motion.div
          className="box"
          animate={{
            x: [0, -400, -800, -1300, -800, -400, 0],
      ...
      <Box sx={{ position: 'absolute', right: 30, bottom: 30 }}>
        <motion.div
          className="box"
          animate={{
            x: [0, -300, -700, -1300, -700, -300, 0],
            y: [0, -50, -100, -200, -100, -50, 0],
            scale: [1, 2, 1, 1, 1],
            rotate: [0, 180, 90, 180, 90],
            borderRadius: ['10%', '30%', '70%', '50%', '10%'],
          }}
      ...
      <Box sx={{ position: 'absolute', left: 30, bottom: 100 }}>
        <motion.div
          className="box"
          animate={{
            x: [0, 300, 1100, 1300, 700, 300, 0],
            y: [0, 50, 100, -300, 100, 50, 0],
            scale: [1, 2, 1, 2, 1],
            rotate: [0, 180, 90, 180, 90],
            borderRadius: ['10%', '30%', '70%', '50%', '10%'],
          }}
